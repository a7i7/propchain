      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8 relative z-10">
          ...
          <p className="text-xl text-gray-600">
            Welcome back, {mockUser.name}! Here's your property portfolio
            overview.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 relative z-10">
          ...
          <div className="bg-white/90 backdrop-blur-sm p-6 rounded-xl shadow-xl border border-white/20 hover:shadow-2xl transition-all duration-300">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p
                  className={`text-sm font-semibold ${
                    activeWallet ? "text-emerald-600" : "text-red-600"
                  }`}
                >
              ...
              <Wallet
                className={`w-8 h-8 ${
                  activeWallet ? "text-emerald-500" : "text-gray-400"
                }`}
              />
            </div>
          </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3 p-4 bg-blue-50 rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      Modern Downtown Loft • 2 hours ago
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3 p-4 bg-purple-50 rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      Waterfront Penthouse • 3 days ago
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  <div className="text-center py-6">
                    ...
                    <p className="text-gray-600 mb-4">
                      Connect your wallet to access NFT properties and
                      blockchain features.
                    </p>
                    <button
                      onClick={showWalletManageDialog}
              ...
              <div className="space-y-4">
                <div className="p-4 bg-emerald-50/80 backdrop-blur-sm rounded-lg border border-emerald-100/50">
                  ...
                  <p className="text-sm text-emerald-700">
                    Property values increased {mockMarketData.monthlyGrowth}{" "}
                    this quarter
                  </p>
                </div>
