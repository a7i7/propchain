              ...
              <div className="relative">
                ...
                <div className="absolute top-4 right-4 flex space-x-2">
                  ...
                  >
                    <Heart
                      className={`w-5 h-5 ${
                        property.favorited ? "fill-current" : ""
                      }`}
                    />
                  </button>
              ...
              <div className="border-t pt-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                  <div>
                    ...
                    <div className="capitalize text-gray-900 mt-1">
                      {property.type}
                    </div>
                  </div>
                  <div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 mb-3">
                        This property is represented as an NFT on the
                        blockchain, ensuring transparent ownership and secure
                        transactions.
                      </p>
